        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        if (!(this._connectionState === "Disconnecting" /* Disconnecting */)) return [3 /*break*/, 3];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 7:
                        e_2 = _a.sent();
                        this._logger.log(ILogger_1.LogLevel.Error, "HttpConnection.transport.stop() threw error '" + e_2 + "'.");
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        ...
                                        if (this_1._connectionState === "Disconnecting" /* Disconnecting */ || this_1._connectionState === "Disconnected" /* Disconnected */) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 11:
                        ex_2 = _a.sent();
                        this._logger.log(ILogger_1.LogLevel.Error, "Failed to start the transport '" + endpoint.transport + "': " + ex_2);
                        negotiate = undefined;
                        transportExceptions.push(new Errors_1.FailedToStartTransportError(endpoint.transport + " failed: " + ex_2, ITransport_1.HttpTransportType[endpoint.transport]));
                        if (this._connectionState !== "Connecting" /* Connecting */) {
                    ...
                    case 13:
                        if (transportExceptions.length > 0) {
                            return [2 /*return*/, Promise.reject(new Errors_1.AggregateErrors("Unable to connect to the server with any of the available transports. " + transportExceptions.join(" "), transportExceptions))];
                        }
    ...
    HttpConnection.prototype._stopConnection = function (error) {
        ...
        if (this._sendQueue) {
            this._sendQueue.stop().catch(function (e) {
                _this._logger.log(ILogger_1.LogLevel.Error, "TransportSendQueue.stop() threw error '" + e + "'.");
            });
