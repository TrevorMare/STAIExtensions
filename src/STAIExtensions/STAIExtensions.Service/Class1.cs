...
public class Class1
{
    ...
    public void Scratch()
    {
        ...
        var tableName = AzureDataExplorerQueryFactory.GetDataContractSourceTableName(DataContractSource.Availability);
        var query = AzureDataExplorerQueryFactory.BuildCustomQuery<IAvailability>(
            tableName, tableName);
